...
<div class="app-shell">
    <aside class="sidebar">
        ...
        <div class="sidebar-section">
            ...
            <a href="{{ route('admin.contacts.issues') }}" class="nav-link {{ request()->routeIs('admin.contacts.issues') ? 'active' : '' }}"><span>Kontak Error</span><span class="nav-meta">{{ number_format($stats['problem_contacts'] ?? 0) }}</span></a>
